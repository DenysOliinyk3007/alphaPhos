...
# MaxQuant ("CON__"), Spectronaut ("Cont_"), generic ("contam_"), and the cRAP
# FASTA tags used with DIA-NN's ``--cont-quant-exclude cRAP-`` ("cRAP-" / "cRAP_").
DEFAULT_CONTAMINANT_PREFIXES: tuple[str, ...] = ("CON__", "Cont_", "contam_", "cRAP-", "cRAP_")
